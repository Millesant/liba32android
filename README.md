...
Feature `010-elf32-gnu-relro` is complete. T001 metadata PASSed CI #231 / run `35942933233`; T002 bounded sealing PASSed CI #232 / run `35943552213`; T003 real post-relocation sealing PASSed CI #234 / run `35946857448`; and T004 convergence PASSed CI #235 / run `35947449163` at `f24c87026b66838c0742bf61ebafe27fba2f117e`. Linux passed 49/49 CTest including `elf32_real_relro_seal`, and both Android jobs passed.
