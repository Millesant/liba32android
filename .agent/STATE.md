...
- RELRO processing: PARTIAL — feature 010 T001 metadata and T002 permission sealing are VERIFIED; T003 real post-relocation sealing is implemented but unvalidated. TLS processing remains NOT IMPLEMENTED.
...
T003 real post-relocation GNU RELRO sealing coverage is prepared; exact-head validation is NOT RUN.
