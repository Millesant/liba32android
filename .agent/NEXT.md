...
- complete feature 023 resumable SVC reporting, then add a bounded host-service dispatcher and catalog-provided ARM32 shim stubs for the highest-priority VLC/FMOD platform APIs;
