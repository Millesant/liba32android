...
Features 020 through 023 are DONE. Feature 023 result revision `4b6234232cef70655272b0877f6c8ae971236a77` passed exact-head Linux A32 smoke and both required Android checks. The CPU seam now exposes a distinguishable resumable SVC trap without Dynarmic types; the next slice can add bounded host-service dispatch above it.
...
- add a bounded host-service dispatch loop above feature 023, then generate catalog-provided ARM32 shim stubs for the highest-priority VLC/FMOD platform APIs;
