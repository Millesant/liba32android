...
- Dynamic-linker scope: structural dynamic entries, validated linker metadata/strings, bounded dependency acquisition, transactional dependency graph loading, SysV/GNU symbol lookup, main REL including R_ARM_REL32 plus eager JUMP_SLOT relocation, an opt-in combined main+PLT rollback domain, and explicit GNU RELRO sealing.
